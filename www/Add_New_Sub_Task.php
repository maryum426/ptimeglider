...
<html>
    ...
    <?php
         ...
         $result2 = mysqli_query($con,"SELECT u.Name,u.User_Id FROM Task_Assignment AS t,User AS u WHERE (t.User_Id = u.User_Id) && (t.Task_Id='$taskid') ");
         
    ?>
    
    
    <body>
        <form id ="form_sub" action="Insert_Sub_Task.php" method="POST">
            ...
            <div class='tg-full_modal_content' >
                <div style="display:inline-block;vertical-align: middle">
                    <div class='textbox_ev_title' style="padding-top: 0px;">
                        ...
                        <input name="task_name" id ="task_name" class='event_title' type='text' value='  new sub task....'>
                    ...
                    <input type="hidden" id ="task" name="task_id" value=""/>
      ...
      document.getElementById('textInput').value=val; 
            ...
            /*$('#choose_icon').click(function(){
                $('#shapes-dialog').load('http://localhost/Project_Timeglider/Shapes_Form.php');
            });*/
