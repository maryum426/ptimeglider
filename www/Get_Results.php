      ...
      <script>
        $(document).ready(function () { 
         ...
         $('#add_proj').click(function(){
                             //alert("Hello");
                             $('#dialog-form').load('C:\\Users\\maryum.babar\\ptimeglider\\www\\Add_New_Project.php');
                    });
            //Drop  down members
                $("#mult").multiselect();
            //Drop down project
       ...
       <body> 
           ...
           <!-- Shapes Form End-->
            ...
            <div class="header-form">
                <form id="project" method="POST" action="C:\\Users\\maryum.babar\\ptimeglider\\www\\Send_JSON.php">
