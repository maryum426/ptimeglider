      ...
      <script>
        $(document).ready(function () { 
         ...
         $('#add_proj').click(function(){
                             //alert("Hello");
                             $('#dialog-form').load('http://localhost/Project_Timeglider/Add_New_Project.php');
                    });
            //Drop  down members
                $("#mult").multiselect();
            //Drop down project
       ...
       <body> 
           ...
           <!-- Shapes Form End-->
            ...
            <div class="header-form">
                <form id="project" method="POST" action="http://localhost/Project_Timeglider/Send_JSON.php">
