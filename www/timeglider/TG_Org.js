						...
						if (b.html && b.html.substr(0,4) == "<div") {
							...
							if (polarity_cond){
								...
								if (b.fontsize > 2) {
									...
									if (b.icon) {
									  icon = "<img class='timeglider-event-icon' src='" + "timeglider/icons/" + b.icon + "' style='height:" + b.fontsize + "px;left:-" + (b.fontsize + 2) + "px; top:" + title_adj + "px'>";
									} else {
									  icon = '';
									}
									...
									html += "<div class='timeglider-timeline-event " 
										...
										+ "left:" + b.left  + "px;" 
										+ "opacity:" + b.opacity + ";"
										+ "top:" + (b.top + top_or_bottom_padding_from_title-50) + "px;"
										+ "font-size:" + 15  + "px; display:inline-block'>"
										+ icon + img + span_div;
										
										if (!lane_sp_title) {
											html += "<div class='timeglider-event-title' style='top:" + title_adj + "10px'>" + b.title + "</div>";
										}
                                                                                //html += "<p class='myline'>..................</p>";
